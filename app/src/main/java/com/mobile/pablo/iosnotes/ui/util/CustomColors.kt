...
internal fun CustomColors.updateColorsFrom(other: CustomColors) {
    ...
    homeBackground = other.noteBackground
    topBarBackground = other.noteBackground
    topBarText = other.noteBackground
    topBarSelectedItemBackground = other.noteBackground
    topBarSelectedItemText = other.noteBackground
    selectedNoteBackground = other.noteBackground
